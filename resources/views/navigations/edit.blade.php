        ...
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            <div class="bg-white dark:bg-gray-800 overflow-hidden shadow-sm sm:rounded-lg">
                <div class="p-6 text-gray-900 dark:text-gray-100">
                    <form method="POST" action="{{ route('navigations.update', $navigation->id) }}">
                        @csrf
                        @if(isset($navigation))
                            @method('PUT')
                        @endif
                        <div class="mt-4">
                            ...
                            <x-text-input id="nav_title" class="block mt-1 w-full" type="text" name="nav_title" value="{{ old('nav_title', $navigation->nav_title ?? '') }}" required autofocus />
                        </div>
                        <div class="mt-4">
